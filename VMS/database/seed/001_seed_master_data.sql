...
-- =============================================================================
-- Run after schema scripts (001–007). Requires empty tables or compatible IDs.
...
-- ---------------------------------------------------------------------------
-- Service centers (3 locations for multi-site dashboards)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Spare parts catalog (parts 1–8 used in inventory + work_order_parts)
-- Unit prices in PKR (demo ranges).
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Mechanics (assigned to centers; used on inspections + labor lines)
-- ---------------------------------------------------------------------------
